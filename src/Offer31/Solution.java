...
public class Solution {
    ...
    包含100个连续点，当最高两位为31（即a=311），本次只对应局部点00~56，共b+1次，所有点加起来共有（a%10*100）+(b+1)，
    这些点百位对应为1
    ...
    /*这个方法主要是对n的每个位数出现过1的次数进行分别运算，然后相加。每个位数都存在三种情况，即大于等于2，
    等于1，等于0。然后再按照上面的讨论*/
    ...
    public static void main(String args[]) {
        new Solution().NumberOf1Between1AndN_Solution(31456);
    }
}
